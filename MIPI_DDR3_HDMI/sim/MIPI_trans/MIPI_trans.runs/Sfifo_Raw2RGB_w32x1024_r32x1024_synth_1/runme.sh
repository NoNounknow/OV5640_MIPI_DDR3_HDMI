...
HD_PWD='D:/three_verilog/MIPI_DDR3_HDMI/sim/MIPI_trans/MIPI_trans.runs/Sfifo_Raw2RGB_w32x1024_r32x1024_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sfifo_Raw2RGB_w32x1024_r32x1024.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sfifo_Raw2RGB_w32x1024_r32x1024.tcl
