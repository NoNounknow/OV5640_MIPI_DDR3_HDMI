...
HD_PWD='D:/three_verilog/MIPI_DDR3_HDMI/sim/MIPI_trans/MIPI_trans.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPI_SIM_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MIPI_SIM_top.tcl -notrace
