...
HD_PWD='D:/three_verilog/MIPI_DDR3_HDMI/sim/MIPI_trans/MIPI_trans.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPI_SIM_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MIPI_SIM_top.tcl
