...
HD_PWD='D:/three_verilog/MIPI_DDR3_HDMI/sim/Mipi_rx_test/Mipi_rx_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPI_rx_test_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MIPI_rx_test_top.tcl
