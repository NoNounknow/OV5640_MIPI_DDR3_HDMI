...
HD_PWD='D:/three_verilog/MIPI_DDR3_HDMI/sim/Mipi_rx_test/Mipi_rx_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPI_rx_test_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MIPI_rx_test_top.tcl -notrace
