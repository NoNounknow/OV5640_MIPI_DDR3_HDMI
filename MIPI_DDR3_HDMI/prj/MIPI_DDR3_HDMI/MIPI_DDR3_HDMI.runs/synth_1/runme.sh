...
HD_PWD='D:/three_verilog/MIPI_DDR3_HDMI/prj/MIPI_DDR3_HDMI/MIPI_DDR3_HDMI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPI_DDR3_HDMI_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MIPI_DDR3_HDMI_top.tcl
