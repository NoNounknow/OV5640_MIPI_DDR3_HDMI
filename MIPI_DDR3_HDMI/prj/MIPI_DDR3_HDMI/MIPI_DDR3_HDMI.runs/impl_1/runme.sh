...
HD_PWD='D:/three_verilog/MIPI_DDR3_HDMI/prj/MIPI_DDR3_HDMI/MIPI_DDR3_HDMI.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPI_DDR3_HDMI_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MIPI_DDR3_HDMI_top.tcl -notrace
